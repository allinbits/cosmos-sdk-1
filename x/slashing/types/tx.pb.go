...
// source: cosmos/slashing/v43beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "cosmos.slashing.v43beta1.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "cosmos.slashing.v43beta1.MsgUnjailResponse")
}

func init() { proto.RegisterFile("cosmos/slashing/v43beta1/tx.proto", fileDescriptor_3c5611c0c4a59d9d) }
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.slashing.v43beta1.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.slashing.v43beta1.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.slashing.v43beta1.Msg",
	...
	Metadata: "cosmos/slashing/v43beta1/tx.proto",
}
