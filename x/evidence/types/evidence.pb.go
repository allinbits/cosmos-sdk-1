...
// source: cosmos/evidence/v43beta1/evidence.proto
...
func init() {
	proto.RegisterType((*Equivocation)(nil), "cosmos.evidence.v43beta1.Equivocation")
}

func init() {
	proto.RegisterFile("cosmos/evidence/v43beta1/evidence.proto", fileDescriptor_dd143e71a177f0dd)
}
