...
// source: cosmos/evidence/v42beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSubmitEvidence)(nil), "cosmos.evidence.v42beta1.MsgSubmitEvidence")
	proto.RegisterType((*MsgSubmitEvidenceResponse)(nil), "cosmos.evidence.v42beta1.MsgSubmitEvidenceResponse")
}

func init() { proto.RegisterFile("cosmos/evidence/v42beta1/tx.proto", fileDescriptor_3e3242cb23c956e0) }
...
func (c *msgClient) SubmitEvidence(ctx context.Context, in *MsgSubmitEvidence, opts ...grpc.CallOption) (*MsgSubmitEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.evidence.v42beta1.Msg/SubmitEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.evidence.v42beta1.Msg/SubmitEvidence",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.evidence.v42beta1.Msg",
	...
	Metadata: "cosmos/evidence/v42beta1/tx.proto",
}
