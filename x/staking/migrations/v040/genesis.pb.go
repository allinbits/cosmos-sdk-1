...
// https://github.com/cosmos/cosmos-sdk/v43/blob/v0.40.1/x/staking/types/genesis.pb.go
...
import (
	...
	github_com_cosmos_cosmos_sdk_types "github.com/cosmos/cosmos-sdk/v43/types"
...
type GenesisState struct {
	...
	LastTotalPower github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=last_total_power,json=lastTotalPower,proto3,customtype=github.com/cosmos/cosmos-sdk/v43/types.Int" json:"last_total_power" yaml:"last_total_power"`
...
func init() {
	// proto.RegisterType((*GenesisState)(nil), "cosmos.staking.v43beta1.GenesisState")
	// proto.RegisterType((*LastValidatorPower)(nil), "cosmos.staking.v43beta1.LastValidatorPower")
}

func init() {
	// proto.RegisterFile("cosmos/staking/v43beta1/genesis.proto", fileDescriptor_9b3dec8894f2831b)
}
