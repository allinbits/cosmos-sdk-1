...
// source: cosmos/staking/v43beta1/authz.proto
...
type StakeAuthorization struct {
	...
	MaxTokens *types.Coin `protobuf:"bytes,1,opt,name=max_tokens,json=maxTokens,proto3,castrepeated=github.com/cosmos/cosmos-sdk/v43/types.Coin" json:"max_tokens,omitempty"`
	...
	AuthorizationType AuthorizationType `protobuf:"varint,4,opt,name=authorization_type,json=authorizationType,proto3,enum=cosmos.staking.v43beta1.AuthorizationType" json:"authorization_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("cosmos.staking.v43beta1.AuthorizationType", AuthorizationType_name, AuthorizationType_value)
	proto.RegisterType((*StakeAuthorization)(nil), "cosmos.staking.v43beta1.StakeAuthorization")
	proto.RegisterType((*StakeAuthorization_Validators)(nil), "cosmos.staking.v43beta1.StakeAuthorization.Validators")
}

func init() {
	proto.RegisterFile("cosmos/staking/v43beta1/authz.proto", fileDescriptor_d6d8cdbc6f4432f0)
}
