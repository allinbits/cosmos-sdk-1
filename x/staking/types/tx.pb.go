...
// source: cosmos/staking/v42beta1/tx.proto
...
import (
	...
	types1 "github.com/cosmos/cosmos-sdk/v42/types"
...
type MsgCreateValidator struct {
	...
	MinSelfDelegation github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/cosmos/cosmos-sdk/v42/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
...
type MsgEditValidator struct {
	...
	// REF: #2373
	CommissionRate    *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/v42/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/cosmos/cosmos-sdk/v42/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
func init() {
	proto.RegisterType((*MsgCreateValidator)(nil), "cosmos.staking.v42beta1.MsgCreateValidator")
	proto.RegisterType((*MsgCreateValidatorResponse)(nil), "cosmos.staking.v42beta1.MsgCreateValidatorResponse")
	proto.RegisterType((*MsgEditValidator)(nil), "cosmos.staking.v42beta1.MsgEditValidator")
	proto.RegisterType((*MsgEditValidatorResponse)(nil), "cosmos.staking.v42beta1.MsgEditValidatorResponse")
	proto.RegisterType((*MsgDelegate)(nil), "cosmos.staking.v42beta1.MsgDelegate")
	proto.RegisterType((*MsgDelegateResponse)(nil), "cosmos.staking.v42beta1.MsgDelegateResponse")
	proto.RegisterType((*MsgBeginRedelegate)(nil), "cosmos.staking.v42beta1.MsgBeginRedelegate")
	proto.RegisterType((*MsgBeginRedelegateResponse)(nil), "cosmos.staking.v42beta1.MsgBeginRedelegateResponse")
	proto.RegisterType((*MsgUndelegate)(nil), "cosmos.staking.v42beta1.MsgUndelegate")
	proto.RegisterType((*MsgUndelegateResponse)(nil), "cosmos.staking.v42beta1.MsgUndelegateResponse")
}

func init() { proto.RegisterFile("cosmos/staking/v42beta1/tx.proto", fileDescriptor_0926ef28816b35ab) }
...
func (c *msgClient) CreateValidator(ctx context.Context, in *MsgCreateValidator, opts ...grpc.CallOption) (*MsgCreateValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v42beta1.Msg/CreateValidator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) EditValidator(ctx context.Context, in *MsgEditValidator, opts ...grpc.CallOption) (*MsgEditValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v42beta1.Msg/EditValidator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Delegate(ctx context.Context, in *MsgDelegate, opts ...grpc.CallOption) (*MsgDelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v42beta1.Msg/Delegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BeginRedelegate(ctx context.Context, in *MsgBeginRedelegate, opts ...grpc.CallOption) (*MsgBeginRedelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v42beta1.Msg/BeginRedelegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Undelegate(ctx context.Context, in *MsgUndelegate, opts ...grpc.CallOption) (*MsgUndelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v42beta1.Msg/Undelegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateValidator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v42beta1.Msg/CreateValidator",
	}
...
func _Msg_EditValidator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v42beta1.Msg/EditValidator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Delegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v42beta1.Msg/Delegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BeginRedelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v42beta1.Msg/BeginRedelegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Undelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v42beta1.Msg/Undelegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.staking.v42beta1.Msg",
	...
	Metadata: "cosmos/staking/v42beta1/tx.proto",
}
