...
import (
	...
	"github.com/cosmos/cosmos-sdk/v42/x/staking/keeper"
	"github.com/cosmos/cosmos-sdk/v42/x/staking/teststaking"
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	// this may not be the desirable behaviour, ref https://github.com/cosmos/cosmos-sdk/v42/issues/1440
	ctx = ctx.WithBlockHeight(13)
	app.StakingKeeper.Slash(ctx, consAddr, 9, 10, fraction)
