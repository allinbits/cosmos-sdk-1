...
// source: cosmos/auth/v43beta1/auth.proto
...
func init() {
	proto.RegisterType((*BaseAccount)(nil), "cosmos.auth.v43beta1.BaseAccount")
	proto.RegisterType((*ModuleAccount)(nil), "cosmos.auth.v43beta1.ModuleAccount")
	proto.RegisterType((*Params)(nil), "cosmos.auth.v43beta1.Params")
}

func init() { proto.RegisterFile("cosmos/auth/v43beta1/auth.proto", fileDescriptor_7e1f7e915d020d2d) }
