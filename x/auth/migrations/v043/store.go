...
// ref: https://github.com/cosmos/cosmos-sdk/v42/issues/8601
// ref: https://github.com/cosmos/cosmos-sdk/v42/issues/8812
//
...
// https://github.com/cosmos/cosmos-sdk/v42/issues/9070
...
import (
	...
	vestingtypes "github.com/cosmos/cosmos-sdk/v42/x/auth/vesting/types"
	banktypes "github.com/cosmos/cosmos-sdk/v42/x/bank/types"
	stakingtypes "github.com/cosmos/cosmos-sdk/v42/x/staking/types"
)

const (
	delegatorDelegationPath           = "/cosmos.staking.v42beta1.Query/DelegatorDelegations"
	stakingParamsPath                 = "/cosmos.staking.v42beta1.Query/Params"
	delegatorUnbondingDelegationsPath = "/cosmos.staking.v42beta1.Query/DelegatorUnbondingDelegations"
	balancesPath                      = "/cosmos.bank.v42beta1.Query/AllBalances"
)
...
// track delegations.
// References: https://github.com/cosmos/cosmos-sdk/v42/issues/8601, https://github.com/cosmos/cosmos-sdk/v42/issues/8812
//
// We use the baseapp.QueryRouter here to do inter-module state querying.
// PLEASE DO NOT REPLICATE THIS PATTERN IN YOUR OWN APP.
