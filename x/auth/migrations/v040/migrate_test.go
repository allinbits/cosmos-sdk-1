...
import (
	...
	"github.com/cosmos/cosmos-sdk/v43/crypto/keys/secp256k1"
	"github.com/cosmos/cosmos-sdk/v43/simapp"
	sdk "github.com/cosmos/cosmos-sdk/v43/types"
	v034 "github.com/cosmos/cosmos-sdk/v43/x/auth/migrations/v034"
	v038auth "github.com/cosmos/cosmos-sdk/v43/x/auth/migrations/v038"
...
func TestMigrate(t *testing.T) {
  ...
  "accounts": [
    {
      "@type": "/cosmos.auth.v43beta1.BaseAccount",
      "account_number": "1",
    ...
    {
      "@type": "/cosmos.auth.v43beta1.ModuleAccount",
      "base_account": {
        "account_number": "1",
    ...
    {
      "@type": "/cosmos.vesting.v43beta1.BaseVestingAccount",
      "base_account": {
        "account_number": "1",
    ...
    {
      "@type": "/cosmos.vesting.v43beta1.ContinuousVestingAccount",
    ...
    {
      "@type": "/cosmos.vesting.v43beta1.PeriodicVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
    ...
    {
      "@type": "/cosmos.vesting.v43beta1.DelayedVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
