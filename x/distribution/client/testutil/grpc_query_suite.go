...
func (s *GRPCQueryTestSuite) TestQueryParamsGRPC() {
	...
	testCases := []struct {
		...
		{
			"gRPC request params",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/params", baseURL),
...
func (s *GRPCQueryTestSuite) TestQueryOutstandingRewardsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/validators/%s/outstanding_rewards", baseURL, "wrongAddress"),
			map[string]string{},
			true,
		...
		},
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/validators/%s/outstanding_rewards", baseURL, val.ValAddress.String()),
			map[string]string{
...
func (s *GRPCQueryTestSuite) TestQueryValidatorCommissionGRPC() {
	...
	testCases := []struct {
		...
		{
			"gRPC request params with wrong validator address",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/validators/%s/commission", baseURL, "wrongAddress"),
			map[string]string{},
			true,
		...
		{
			"gRPC request params valid address",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/validators/%s/commission", baseURL, val.ValAddress.String()),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
...
func (s *GRPCQueryTestSuite) TestQuerySlashesGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/validators/%s/slashes", baseURL, ""),
			true,
		...
		},
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/validators/%s/slashes?starting_height=%s&ending_height=%s", baseURL, val.ValAddress.String(), "-1", "3"),
			true,
			&types.QueryValidatorSlashesResponse{},
			nil,
		},
...
func (s *GRPCQueryTestSuite) TestQueryDelegatorRewardsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/rewards", baseURL, "wrongDelegatorAddress"),
			map[string]string{},
			true,
		...
		{
			"valid request",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/rewards", baseURL, val.Address.String()),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
		...
		},
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/rewards/%s", baseURL, val.Address.String(), "wrongValAddress"),
			map[string]string{},
			true,
			&types.QueryDelegationTotalRewardsResponse{},
			nil,
		},
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/rewards/%s", baseURL, val.Address.String(), val.ValAddress.String()),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
...
func (s *GRPCQueryTestSuite) TestQueryDelegatorValidatorsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/validators", baseURL, ""),
			true,
		...
		{
			"wrong delegator address",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/validators", baseURL, "wrongDelegatorAddress"),
			true,
			&types.QueryDelegatorValidatorsResponse{},
			nil,
		},
		{
			"valid request",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/validators", baseURL, val.Address.String()),
			false,
			&types.QueryDelegatorValidatorsResponse{},
			&types.QueryDelegatorValidatorsResponse{
...
func (s *GRPCQueryTestSuite) TestQueryWithdrawAddressGRPC() {
	...
	testCases := []struct {
		...
		{
			"empty delegator address",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/withdraw_address", baseURL, ""),
			true,
		...
		{
			"wrong delegator address",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/withdraw_address", baseURL, "wrongDelegatorAddress"),
			true,
			&types.QueryDelegatorWithdrawAddressResponse{},
			nil,
		},
		{
			"valid request",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/delegators/%s/withdraw_address", baseURL, val.Address.String()),
			false,
			&types.QueryDelegatorWithdrawAddressResponse{},
			&types.QueryDelegatorWithdrawAddressResponse{
...
func (s *GRPCQueryTestSuite) TestQueryValidatorCommunityPoolGRPC() {
	...
	testCases := []struct {
		...
		{
			"gRPC request params with wrong validator address",
			fmt.Sprintf("%s/cosmos/distribution/v43beta1/community_pool", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
