...
// source: cosmos/gov/v43beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.gov.v43beta1.GenesisState")
}

func init() { proto.RegisterFile("cosmos/gov/v43beta1/genesis.proto", fileDescriptor_43cd825e0fa7a627) }
