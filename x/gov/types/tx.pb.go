...
// source: cosmos/gov/v43beta1/tx.proto
...
type MsgSubmitProposal struct {
	...
	InitialDeposit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=initial_deposit,json=initialDeposit,proto3,castrepeated=github.com/cosmos/cosmos-sdk/v43/types.Coins" json:"initial_deposit" yaml:"initial_deposit"`
...
type MsgVote struct {
	...
	Option     VoteOption `protobuf:"varint,3,opt,name=option,proto3,enum=cosmos.gov.v43beta1.VoteOption" json:"option,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgSubmitProposal)(nil), "cosmos.gov.v43beta1.MsgSubmitProposal")
	proto.RegisterType((*MsgSubmitProposalResponse)(nil), "cosmos.gov.v43beta1.MsgSubmitProposalResponse")
	proto.RegisterType((*MsgVote)(nil), "cosmos.gov.v43beta1.MsgVote")
	proto.RegisterType((*MsgVoteResponse)(nil), "cosmos.gov.v43beta1.MsgVoteResponse")
	proto.RegisterType((*MsgVoteWeighted)(nil), "cosmos.gov.v43beta1.MsgVoteWeighted")
	proto.RegisterType((*MsgVoteWeightedResponse)(nil), "cosmos.gov.v43beta1.MsgVoteWeightedResponse")
	proto.RegisterType((*MsgDeposit)(nil), "cosmos.gov.v43beta1.MsgDeposit")
	proto.RegisterType((*MsgDepositResponse)(nil), "cosmos.gov.v43beta1.MsgDepositResponse")
}

func init() { proto.RegisterFile("cosmos/gov/v43beta1/tx.proto", fileDescriptor_3c053992595e3dce) }
...
func (c *msgClient) SubmitProposal(ctx context.Context, in *MsgSubmitProposal, opts ...grpc.CallOption) (*MsgSubmitProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.gov.v43beta1.Msg/SubmitProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Vote(ctx context.Context, in *MsgVote, opts ...grpc.CallOption) (*MsgVoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.gov.v43beta1.Msg/Vote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) VoteWeighted(ctx context.Context, in *MsgVoteWeighted, opts ...grpc.CallOption) (*MsgVoteWeightedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.gov.v43beta1.Msg/VoteWeighted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Deposit(ctx context.Context, in *MsgDeposit, opts ...grpc.CallOption) (*MsgDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.gov.v43beta1.Msg/Deposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.gov.v43beta1.Msg/SubmitProposal",
	}
...
func _Msg_Vote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.gov.v43beta1.Msg/Vote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_VoteWeighted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.gov.v43beta1.Msg/VoteWeighted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Deposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.gov.v43beta1.Msg/Deposit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.gov.v43beta1.Msg",
	...
	Metadata: "cosmos/gov/v43beta1/tx.proto",
}
