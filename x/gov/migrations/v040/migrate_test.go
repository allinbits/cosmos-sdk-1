...
func TestMigrate(t *testing.T) {
	...
	"proposals": [
		{
			"content": {
				"@type": "/cosmos.gov.v42beta1.TextProposal",
				"description": "bar_text",
				"title": "foo_text"
			},
		...
		{
			"content": {
				"@type": "/cosmos.distribution.v42beta1.CommunityPoolSpendProposal",
				"amount": [
					{
						"amount": "2",
						"denom": "footoken"
		...
		{
			"content": {
				"@type": "/cosmos.upgrade.v42beta1.CancelSoftwareUpgradeProposal",
				"description": "bar_cancel_upgrade",
				"title": "foo_cancel_upgrade"
			},
			"deposit_end_time": "0001-01-01T00:00:00Z",
		...
		{
			"content": {
				"@type": "/cosmos.upgrade.v42beta1.SoftwareUpgradeProposal",
				"description": "bar_software_upgrade",
				"plan": {
					"height": "123",
					"info": "foo_upgrade_info",
		...
		{
			"content": {
				"@type": "/cosmos.params.v42beta1.ParameterChangeProposal",
				"changes": [
					{
						"key": "foo_param_change_key",
						"subspace": "foo_param_change_subspace",
