...
import (
	...
	"github.com/cosmos/cosmos-sdk/v42/x/gov/client/cli"
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/cosmos/cosmos-sdk/v42/tree/master/cosmovisor",
