...
import (
	...
	"github.com/cosmos/cosmos-sdk/v43/x/gov/client/cli"
	gov "github.com/cosmos/cosmos-sdk/v43/x/gov/types"
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/cosmos/cosmos-sdk/v43/tree/master/cosmovisor",
