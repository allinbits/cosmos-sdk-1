...
// source: cosmos/genutil/v42beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.genutil.v42beta1.GenesisState")
}

func init() {
	proto.RegisterFile("cosmos/genutil/v42beta1/genesis.proto", fileDescriptor_31771d25e8d8f90f)
}
