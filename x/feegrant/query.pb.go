...
// source: cosmos/feegrant/v42beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryAllowanceRequest)(nil), "cosmos.feegrant.v42beta1.QueryAllowanceRequest")
	proto.RegisterType((*QueryAllowanceResponse)(nil), "cosmos.feegrant.v42beta1.QueryAllowanceResponse")
	proto.RegisterType((*QueryAllowancesRequest)(nil), "cosmos.feegrant.v42beta1.QueryAllowancesRequest")
	proto.RegisterType((*QueryAllowancesResponse)(nil), "cosmos.feegrant.v42beta1.QueryAllowancesResponse")
}

func init() {
	proto.RegisterFile("cosmos/feegrant/v42beta1/query.proto", fileDescriptor_59efc303945de53f)
}
...
func (c *queryClient) Allowance(ctx context.Context, in *QueryAllowanceRequest, opts ...grpc.CallOption) (*QueryAllowanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.feegrant.v42beta1.Query/Allowance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Allowances(ctx context.Context, in *QueryAllowancesRequest, opts ...grpc.CallOption) (*QueryAllowancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.feegrant.v42beta1.Query/Allowances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Allowance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.feegrant.v42beta1.Query/Allowance",
	}
...
func _Query_Allowances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.feegrant.v42beta1.Query/Allowances",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.feegrant.v42beta1.Query",
	...
	Metadata: "cosmos/feegrant/v42beta1/query.proto",
}
