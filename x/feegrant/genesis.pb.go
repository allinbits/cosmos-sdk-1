...
// source: cosmos/feegrant/v43beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.feegrant.v43beta1.GenesisState")
}

func init() {
	proto.RegisterFile("cosmos/feegrant/v43beta1/genesis.proto", fileDescriptor_ac719d2d0954d1bf)
}
