...
// source: cosmos/feegrant/v42beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.feegrant.v42beta1.GenesisState")
}

func init() {
	proto.RegisterFile("cosmos/feegrant/v42beta1/genesis.proto", fileDescriptor_ac719d2d0954d1bf)
}
