...
// source: cosmos/crisis/v42beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgVerifyInvariant)(nil), "cosmos.crisis.v42beta1.MsgVerifyInvariant")
	proto.RegisterType((*MsgVerifyInvariantResponse)(nil), "cosmos.crisis.v42beta1.MsgVerifyInvariantResponse")
}

func init() { proto.RegisterFile("cosmos/crisis/v42beta1/tx.proto", fileDescriptor_61276163172fe867) }
...
func (c *msgClient) VerifyInvariant(ctx context.Context, in *MsgVerifyInvariant, opts ...grpc.CallOption) (*MsgVerifyInvariantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.crisis.v42beta1.Msg/VerifyInvariant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_VerifyInvariant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.crisis.v42beta1.Msg/VerifyInvariant",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.crisis.v42beta1.Msg",
	...
	Metadata: "cosmos/crisis/v42beta1/tx.proto",
}
