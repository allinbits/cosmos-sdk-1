...
// source: cosmos/authz/v43beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryGrantsRequest)(nil), "cosmos.authz.v43beta1.QueryGrantsRequest")
	proto.RegisterType((*QueryGrantsResponse)(nil), "cosmos.authz.v43beta1.QueryGrantsResponse")
}

func init() { proto.RegisterFile("cosmos/authz/v43beta1/query.proto", fileDescriptor_376d714ffdeb1545) }
...
func (c *queryClient) Grants(ctx context.Context, in *QueryGrantsRequest, opts ...grpc.CallOption) (*QueryGrantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v43beta1.Query/Grants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Grants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v43beta1.Query/Grants",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.authz.v43beta1.Query",
	...
	Metadata: "cosmos/authz/v43beta1/query.proto",
}
