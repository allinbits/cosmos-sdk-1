...
// source: cosmos/authz/v42beta1/authz.proto
...
func init() {
	proto.RegisterType((*GenericAuthorization)(nil), "cosmos.authz.v42beta1.GenericAuthorization")
	proto.RegisterType((*Grant)(nil), "cosmos.authz.v42beta1.Grant")
}

func init() { proto.RegisterFile("cosmos/authz/v42beta1/authz.proto", fileDescriptor_544dc2e84b61c637) }
