...
// source: cosmos/authz/v43beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.authz.v43beta1.GenesisState")
	proto.RegisterType((*GrantAuthorization)(nil), "cosmos.authz.v43beta1.GrantAuthorization")
}

func init() {
	proto.RegisterFile("cosmos/authz/v43beta1/genesis.proto", fileDescriptor_4c2fbb971da7c892)
}
