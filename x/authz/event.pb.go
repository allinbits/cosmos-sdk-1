...
// source: cosmos/authz/v42beta1/event.proto
...
func init() {
	proto.RegisterType((*EventGrant)(nil), "cosmos.authz.v42beta1.EventGrant")
	proto.RegisterType((*EventRevoke)(nil), "cosmos.authz.v42beta1.EventRevoke")
}

func init() { proto.RegisterFile("cosmos/authz/v42beta1/event.proto", fileDescriptor_1f88cbc71a8baf1f) }
