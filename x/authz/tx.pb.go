...
// source: cosmos/authz/v43beta1/tx.proto
...
import (
	...
	_ "github.com/cosmos/cosmos-sdk/v43/types"
...
func init() {
	proto.RegisterType((*MsgGrant)(nil), "cosmos.authz.v43beta1.MsgGrant")
	proto.RegisterType((*MsgExecResponse)(nil), "cosmos.authz.v43beta1.MsgExecResponse")
	proto.RegisterType((*MsgExec)(nil), "cosmos.authz.v43beta1.MsgExec")
	proto.RegisterType((*MsgGrantResponse)(nil), "cosmos.authz.v43beta1.MsgGrantResponse")
	proto.RegisterType((*MsgRevoke)(nil), "cosmos.authz.v43beta1.MsgRevoke")
	proto.RegisterType((*MsgRevokeResponse)(nil), "cosmos.authz.v43beta1.MsgRevokeResponse")
}

func init() { proto.RegisterFile("cosmos/authz/v43beta1/tx.proto", fileDescriptor_3ceddab7d8589ad1) }
...
func (c *msgClient) Grant(ctx context.Context, in *MsgGrant, opts ...grpc.CallOption) (*MsgGrantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v43beta1.Msg/Grant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Exec(ctx context.Context, in *MsgExec, opts ...grpc.CallOption) (*MsgExecResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v43beta1.Msg/Exec", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Revoke(ctx context.Context, in *MsgRevoke, opts ...grpc.CallOption) (*MsgRevokeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v43beta1.Msg/Revoke", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Grant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v43beta1.Msg/Grant",
	}
...
func _Msg_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v43beta1.Msg/Exec",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Revoke_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v43beta1.Msg/Revoke",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.authz.v43beta1.Msg",
	...
	Metadata: "cosmos/authz/v43beta1/tx.proto",
}
