...
// source: cosmos/capability/v43beta1/capability.proto
...
func init() {
	proto.RegisterType((*Capability)(nil), "cosmos.capability.v43beta1.Capability")
	proto.RegisterType((*Owner)(nil), "cosmos.capability.v43beta1.Owner")
	proto.RegisterType((*CapabilityOwners)(nil), "cosmos.capability.v43beta1.CapabilityOwners")
}

func init() {
	proto.RegisterFile("cosmos/capability/v43beta1/capability.proto", fileDescriptor_6308261edd8470a9)
}
