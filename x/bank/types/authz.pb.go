...
// source: cosmos/bank/v42beta1/authz.proto
...
func init() {
	proto.RegisterType((*SendAuthorization)(nil), "cosmos.bank.v42beta1.SendAuthorization")
}

func init() { proto.RegisterFile("cosmos/bank/v42beta1/authz.proto", fileDescriptor_a4d2a37888ea779f) }
