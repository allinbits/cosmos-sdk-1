...
// source: cosmos/bank/v43beta1/bank.proto
...
type Input struct {
	...
	Coins   github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/v43/types.Coins" json:"coins"`
}
...
type Supply struct {
	Total github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/cosmos/cosmos-sdk/v43/types.Coins" json:"total"`
}
...
func init() {
	proto.RegisterType((*Params)(nil), "cosmos.bank.v43beta1.Params")
	proto.RegisterType((*SendEnabled)(nil), "cosmos.bank.v43beta1.SendEnabled")
	proto.RegisterType((*Input)(nil), "cosmos.bank.v43beta1.Input")
	proto.RegisterType((*Output)(nil), "cosmos.bank.v43beta1.Output")
	proto.RegisterType((*Supply)(nil), "cosmos.bank.v43beta1.Supply")
	proto.RegisterType((*DenomUnit)(nil), "cosmos.bank.v43beta1.DenomUnit")
	proto.RegisterType((*Metadata)(nil), "cosmos.bank.v43beta1.Metadata")
}

func init() { proto.RegisterFile("cosmos/bank/v43beta1/bank.proto", fileDescriptor_dd052eee12edf988) }
