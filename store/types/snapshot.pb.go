...
// source: cosmos/base/store/v42beta1/snapshot.proto
...
func init() {
	proto.RegisterType((*SnapshotItem)(nil), "cosmos.base.store.v42beta1.SnapshotItem")
	proto.RegisterType((*SnapshotStoreItem)(nil), "cosmos.base.store.v42beta1.SnapshotStoreItem")
	proto.RegisterType((*SnapshotIAVLItem)(nil), "cosmos.base.store.v42beta1.SnapshotIAVLItem")
}

func init() {
	proto.RegisterFile("cosmos/base/store/v42beta1/snapshot.proto", fileDescriptor_9c55879db4cc4502)
}
