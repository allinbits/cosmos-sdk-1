...
// source: cosmos/base/store/v43beta1/listening.proto
...
func init() {
	proto.RegisterType((*StoreKVPair)(nil), "cosmos.base.store.v43beta1.StoreKVPair")
}

func init() {
	proto.RegisterFile("cosmos/base/store/v43beta1/listening.proto", fileDescriptor_a5d350879fe4fecd)
}
