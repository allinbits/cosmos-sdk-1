...
import (
	...
	sdkmaps "github.com/cosmos/cosmos-sdk/v43/store/internal/maps"
...
func benchmarkMultistoreSnapshot(b *testing.B, stores uint8, storeKeys uint64) {
	b.Skip("Noisy with slow setup time, please see https://github.com/cosmos/cosmos-sdk/v43/issues/8855.")
