...
// source: cosmos/tx/v43beta1/service.proto
...
type GetTxsEventRequest struct {
	...
	OrderBy    OrderBy            `protobuf:"varint,3,opt,name=order_by,json=orderBy,proto3,enum=cosmos.tx.v43beta1.OrderBy" json:"order_by,omitempty"`
}
...
type BroadcastTxRequest struct {
	...
	Mode    BroadcastMode `protobuf:"varint,2,opt,name=mode,proto3,enum=cosmos.tx.v43beta1.BroadcastMode" json:"mode,omitempty"`
}
...
func init() {
	proto.RegisterEnum("cosmos.tx.v43beta1.OrderBy", OrderBy_name, OrderBy_value)
	golang_proto.RegisterEnum("cosmos.tx.v43beta1.OrderBy", OrderBy_name, OrderBy_value)
	proto.RegisterEnum("cosmos.tx.v43beta1.BroadcastMode", BroadcastMode_name, BroadcastMode_value)
	golang_proto.RegisterEnum("cosmos.tx.v43beta1.BroadcastMode", BroadcastMode_name, BroadcastMode_value)
	proto.RegisterType((*GetTxsEventRequest)(nil), "cosmos.tx.v43beta1.GetTxsEventRequest")
	golang_proto.RegisterType((*GetTxsEventRequest)(nil), "cosmos.tx.v43beta1.GetTxsEventRequest")
	proto.RegisterType((*GetTxsEventResponse)(nil), "cosmos.tx.v43beta1.GetTxsEventResponse")
	golang_proto.RegisterType((*GetTxsEventResponse)(nil), "cosmos.tx.v43beta1.GetTxsEventResponse")
	proto.RegisterType((*BroadcastTxRequest)(nil), "cosmos.tx.v43beta1.BroadcastTxRequest")
	golang_proto.RegisterType((*BroadcastTxRequest)(nil), "cosmos.tx.v43beta1.BroadcastTxRequest")
	proto.RegisterType((*BroadcastTxResponse)(nil), "cosmos.tx.v43beta1.BroadcastTxResponse")
	golang_proto.RegisterType((*BroadcastTxResponse)(nil), "cosmos.tx.v43beta1.BroadcastTxResponse")
	proto.RegisterType((*SimulateRequest)(nil), "cosmos.tx.v43beta1.SimulateRequest")
	golang_proto.RegisterType((*SimulateRequest)(nil), "cosmos.tx.v43beta1.SimulateRequest")
	proto.RegisterType((*SimulateResponse)(nil), "cosmos.tx.v43beta1.SimulateResponse")
	golang_proto.RegisterType((*SimulateResponse)(nil), "cosmos.tx.v43beta1.SimulateResponse")
	proto.RegisterType((*GetTxRequest)(nil), "cosmos.tx.v43beta1.GetTxRequest")
	golang_proto.RegisterType((*GetTxRequest)(nil), "cosmos.tx.v43beta1.GetTxRequest")
	proto.RegisterType((*GetTxResponse)(nil), "cosmos.tx.v43beta1.GetTxResponse")
	golang_proto.RegisterType((*GetTxResponse)(nil), "cosmos.tx.v43beta1.GetTxResponse")
}

func init() { proto.RegisterFile("cosmos/tx/v43beta1/service.proto", fileDescriptor_e0b00a618705eca7) }
func init() {
	golang_proto.RegisterFile("cosmos/tx/v43beta1/service.proto", fileDescriptor_e0b00a618705eca7)
}
...
func (c *serviceClient) Simulate(ctx context.Context, in *SimulateRequest, opts ...grpc.CallOption) (*SimulateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.tx.v43beta1.Service/Simulate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetTx(ctx context.Context, in *GetTxRequest, opts ...grpc.CallOption) (*GetTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.tx.v43beta1.Service/GetTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) BroadcastTx(ctx context.Context, in *BroadcastTxRequest, opts ...grpc.CallOption) (*BroadcastTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.tx.v43beta1.Service/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetTxsEvent(ctx context.Context, in *GetTxsEventRequest, opts ...grpc.CallOption) (*GetTxsEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.tx.v43beta1.Service/GetTxsEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Simulate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.tx.v43beta1.Service/Simulate",
	}
...
func _Service_GetTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.tx.v43beta1.Service/GetTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.tx.v43beta1.Service/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_GetTxsEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.tx.v43beta1.Service/GetTxsEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Service_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.tx.v43beta1.Service",
	...
	Metadata: "cosmos/tx/v43beta1/service.proto",
}
