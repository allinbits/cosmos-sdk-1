...
// source: cosmos/tx/v42beta1/tx.proto
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/cosmos/cosmos-sdk/v42/issues/9122).
...
type ModeInfo_Single struct {
	...
	Mode signing.SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=cosmos.tx.signing.v42beta1.SignMode" json:"mode,omitempty"`
}
...
func init() {
	proto.RegisterType((*Tx)(nil), "cosmos.tx.v42beta1.Tx")
	proto.RegisterType((*TxRaw)(nil), "cosmos.tx.v42beta1.TxRaw")
	proto.RegisterType((*SignDoc)(nil), "cosmos.tx.v42beta1.SignDoc")
	proto.RegisterType((*SignDocJSON)(nil), "cosmos.tx.v42beta1.SignDocJSON")
	proto.RegisterType((*SignDocDirectAux)(nil), "cosmos.tx.v42beta1.SignDocDirectAux")
	proto.RegisterType((*TxBody)(nil), "cosmos.tx.v42beta1.TxBody")
	proto.RegisterType((*AuthInfo)(nil), "cosmos.tx.v42beta1.AuthInfo")
	proto.RegisterType((*SignerInfo)(nil), "cosmos.tx.v42beta1.SignerInfo")
	proto.RegisterType((*ModeInfo)(nil), "cosmos.tx.v42beta1.ModeInfo")
	proto.RegisterType((*ModeInfo_Single)(nil), "cosmos.tx.v42beta1.ModeInfo.Single")
	proto.RegisterType((*ModeInfo_Multi)(nil), "cosmos.tx.v42beta1.ModeInfo.Multi")
	proto.RegisterType((*Fee)(nil), "cosmos.tx.v42beta1.Fee")
	proto.RegisterType((*Tip)(nil), "cosmos.tx.v42beta1.Tip")
}

func init() { proto.RegisterFile("cosmos/tx/v42beta1/tx.proto", fileDescriptor_96d1575ffde80842) }
