...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/cosmos/cosmos-sdk/v43/types/errors.Wrap",
		"github.com/cosmos/cosmos-sdk/v43/types/errors.Wrapf",
		"github.com/cosmos/cosmos-sdk/v43/types/errors.WithType",
