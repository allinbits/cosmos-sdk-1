...
// source: cosmos/base/query/v43beta1/pagination.proto
...
func init() {
	proto.RegisterType((*PageRequest)(nil), "cosmos.base.query.v43beta1.PageRequest")
	proto.RegisterType((*PageResponse)(nil), "cosmos.base.query.v43beta1.PageResponse")
}

func init() {
	proto.RegisterFile("cosmos/base/query/v43beta1/pagination.proto", fileDescriptor_53d6d609fe6828af)
}
