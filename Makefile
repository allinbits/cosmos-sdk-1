...
ifeq ($(LEDGER_ENABLED),true)
  ifeq ($(OS),Windows_NT)
    ...
    ifeq ($(UNAME_S),OpenBSD)
      $(warning OpenBSD detected, disabling ledger support (https://github.com/cosmos/cosmos-sdk/v42/issues/1988))
    else
...
ldflags = -X github.com/cosmos/cosmos-sdk/v42/version.Name=sim \
		  -X github.com/cosmos/cosmos-sdk/v42/version.AppName=simd \
		  -X github.com/cosmos/cosmos-sdk/v42/version.Version=$(VERSION) \
		  -X github.com/cosmos/cosmos-sdk/v42/version.Commit=$(COMMIT) \
		  -X "github.com/cosmos/cosmos-sdk/v42/version.BuildTags=$(build_tags_comma_sep)" \
			-X github.com/tendermint/tendermint/version.TMCoreSemVer=$(TMVERSION)

# DB backend selection
ifeq (cleveldb,$(findstring cleveldb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/cosmos/cosmos-sdk/v42/types.DBBackend=cleveldb
endif
ifeq (badgerdb,$(findstring badgerdb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/cosmos/cosmos-sdk/v42/types.DBBackend=badgerdb
  BUILD_TAGS += badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(COSMOS_BUILD_OPTIONS)))
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/cosmos/cosmos-sdk/v42/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(COSMOS_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
  ldflags += -X github.com/cosmos/cosmos-sdk/v42/types.DBBackend=boltdb
endif
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/cosmos/cosmos-sdk/v42/types"
	godoc -http=:6060
