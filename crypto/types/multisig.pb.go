...
// source: cosmos/crypto/multisig/v42beta1/multisig.proto
...
func init() {
	proto.RegisterType((*MultiSignature)(nil), "cosmos.crypto.multisig.v42beta1.MultiSignature")
	proto.RegisterType((*CompactBitArray)(nil), "cosmos.crypto.multisig.v42beta1.CompactBitArray")
}

func init() {
	proto.RegisterFile("cosmos/crypto/multisig/v42beta1/multisig.proto", fileDescriptor_1177bdf7025769be)
}
